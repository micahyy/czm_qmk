 ...
 * Clock: HEXT 12MHz, MS=1 NS=72 FP=4 -> SYSCLK=216MHz, FU=18 -> USB=48MHz
 */
...
/* LDO voltage level 3 required for 216MHz operation */
 ...
 * OTG2 (OTGHS on-chip HS PHY) for 480Mbps High Speed.
 * BOARD_OTG2_USES_ULPI in board.h enables HS clock path.
 * AT32_USE_USB_OTG2_HS=TRUE reports HS device speed for 8000Hz polling.
 */

...
This firmware uses VID 0x1A2C / PID 0x50EF and product name "HID Keyboard Device" for game throne compatibility. Do not change these settings.
此固件使用 VID 0x1A2C / PID 0x50EF 和产品名 "HID Keyboard Device" 以适配游戏王座，请勿修改。

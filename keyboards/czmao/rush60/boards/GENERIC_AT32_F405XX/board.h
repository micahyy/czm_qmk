...
/* Target device: AT32F405RCT7-7 - LQFP64, 256KB Flash, 96KB SRAM,
 * OTG-HS capable. Selects the LQFP64 set in the ChibiOS-Contrib registry. */
#define AT32F405RCT7_7
...
/* AT32F405RC has GPIOA, GPIOB, GPIOC, GPIOD, GPIOF */
...
/* OTGHS uses on-chip HS PHY; this macro selects HS clock/path in ChibiOS */
...
/* PIN helper macros matching AT32 F402/F405 GPIOv2 registers */
...
/*
 * Port A setup.
 * All pins input pull-up except PA11/PA12 (OTGFS, floating).
 * PA13/PA14 are SWD (mux), but QMK matrix_init reconfigures PA14 as col input.
 */
#define VAL_GPIOA_CFGR              (PIN_MODE_INPUT(GPIOA_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOA_LED_CAPS) |       \
...
#define VAL_GPIOA_OMODE             0U
#define VAL_GPIOA_ODRVR             0U
#define VAL_GPIOA_PULL              (PIN_PULL_PULLUP(GPIOA_PIN0) |          \
                                     PIN_PULL_PULLUP(GPIOA_PIN1) |          \
                                     PIN_PULL_PULLUP(GPIOA_LED_CAPS) |      \
...
#define VAL_GPIOA_MUXL              0U
#define VAL_GPIOA_MUXH              0U
#define VAL_GPIOA_HDRV              0U

/*
 * Port B setup. All pins input pull-up except PB13 (VBUS, floating).
 * AT32F405RC LQFP64 does not have PB14/PB15.
 */
#define VAL_GPIOB_CFGR              (PIN_MODE_INPUT(GPIOB_PIN0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_USB_VBUS))
#define VAL_GPIOB_OMODE             0U
#define VAL_GPIOB_ODRVR             0U
#define VAL_GPIOB_PULL              (PIN_PULL_PULLUP(GPIOB_PIN0) |          \
                                     ...
                                     PIN_PULL_FLOATING(GPIOB_USB_VBUS))
#define VAL_GPIOB_ODT               0xFFFFFFFFU
#define VAL_GPIOB_MUXL              0U
#define VAL_GPIOB_MUXH              0U
#define VAL_GPIOB_HDRV              0U

/*
 * Port C setup. All pins input pull-up.
 * Pins PC12/PC11/PC10/PC5/PC3/PC2 are matrix row outputs (reconfigured by QMK).
 */
#define VAL_GPIOC_CFGR              0U
#define VAL_GPIOC_OMODE             0U
#define VAL_GPIOC_ODRVR             0U
...
#define VAL_GPIOC_MUXL              0U
#define VAL_GPIOC_MUXH              0U
#define VAL_GPIOC_HDRV              0U

/*
 * Port D setup. PD2 is Scroll Lock LED (reconfigured by QMK).
 */
#define VAL_GPIOD_CFGR              (PIN_MODE_INPUT(GPIOD_PIN2))
#define VAL_GPIOD_OMODE             0U
#define VAL_GPIOD_ODRVR             0U
#define VAL_GPIOD_PULL              (PIN_PULL_PULLUP(GPIOD_PIN2))
#define VAL_GPIOD_ODT               (PIN_ODT_HIGH(GPIOD_PIN2))
#define VAL_GPIOD_MUXL              0U
#define VAL_GPIOD_MUXH              0U
#define VAL_GPIOD_HDRV              0U

/*
 * Port F setup. PF0/PF1 are HEXT crystal (floating).
 */
#define VAL_GPIOF_CFGR              (PIN_MODE_INPUT(GPIOF_HEXT_IN) |        \
                                     PIN_MODE_INPUT(GPIOF_HEXT_OUT))
#define VAL_GPIOF_OMODE             0U
#define VAL_GPIOF_ODRVR             0U
...
#define VAL_GPIOF_MUXL              0U
#define VAL_GPIOF_MUXH              0U
#define VAL_GPIOF_HDRV              0U
